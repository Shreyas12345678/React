   ...
   //settitle("this is updated");
    return (
        ...
        <h1 > {props.title} </h1>
            ...
            <button type="button" className="btn btn-primary mx-2" onClick={updatecount} >Toupper</button> 
            
            <button type="button" className="btn btn-warning mx-2" onClick={lower}>Tolower</button>
            <button  type="button" className="btn btn-success mx2" onClick={cleartext}>Clear all</button>
            <button  type="button" className="btn btn-success mx-2 "   onClick={makeBold}>Undo</button>
            <button  type="button" className="btn btn-success mx-2" onClick={changecolor}>Changecolor</button>
            <button  type="button" className="btn btn-success mx-2" onClick={handlecopy}>Copy Text</button>
        </div>

        <div className="container" style={{color:props.mode==='dark'?'white':'#042743'}}>
            <h1>summary</h1>
            <p>{text.split(" ").length-1} no of words and {text.length} no of character</p>
